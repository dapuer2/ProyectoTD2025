...
```{r,echo=FALSE, grafico, fig.width=6, fig.height=4,fig.align="center"}
...
```{r, echo = FALSE,grafico2, fig.width=6, fig.height=4,fig.align="center"}
...
```{r,echo=FALSE,grafico3, fig.width=6, fig.height=4,fig.align="center"}
...
```{r, echo=FALSE,message=FALSE,warning=FALSE,grafico4,fig.width=6, fig.height=4,fig.align="center"}
...
```{r,fig.align="center",echo=FALSE,grafico5, fig.width=6, fig.height=4}
...
Valencia claramente lidera con 130 tickets. Alboraya aparece en segundo lugar con 50 tickets.
    ...
    6)  Muestra mediante un diagrama el número de tickets recogidos cada
        ...
        qué día lo harías?
```{r,fig.align="center",echo=FALSE,grafico6,fig.width=6,fig.height=4}
...
```{r,fig.align="center",echo=FALSE,grafico7,fig.width=6,fig.height=4}
...
```{r,fig.align="center",echo=FALSE,grafico8,fig.width=6,fig.height=4}
...
```{r,echo=FALSE,fig.align="center",grafico9,fig.width=6,fig.height=4}
...
```
    ...
    10) ¿Cuál es la tienda en la que más se ha comprado? (Dirección
        tienda)
```{r,fig.align="center",echo=FALSE,grafico10,fig.width=6,fig.height=4}
df.ticket%>%
...
```{r,fig.align="center",echo=FALSE,grafico11,fig.width=6,fig.height=4}
...
```{r,fig.align="center",echo=FALSE,grafico12,fig.width=6,fig.height=4}
