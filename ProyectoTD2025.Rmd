...
df.productos <- df.productos %>%
  mutate(
    nombre.producto = gsub("Ã\\u008d", "Í", nombre.producto),
    nombre.producto = gsub("Ã\\u0081", "Á", nombre.producto),
    nombre.producto = gsub("Ã\\u0096", "Ö", nombre.producto),
    nombre.producto = trimws(nombre.producto)
  ) %>%
...
Estas son las preguntas que tenemos que responder mediante gráficos.
  ...
  - ¿Cuáles son los 5 productos, de los vendidos por unidades, con más ventas ? ¿Cuántas unidades de        cada uno se han vendido ?Ç
