...
resumen_variables <- resumen %>%
  ...
  cols_label(
    Variable = "Variable",
    tipo = "Tipo",
    niveles = "Niveles Únicos",
    topLevel = "Valor Más Frecuente",
    topCount = "Frecuencia",
    topFrac = "% del Total",
    missFrac = "Valores Faltantes"
  ) %>%
...
numericas <- numericas %>%
  ...
  reactable(
    columns = list(
      ...
      Media = colDef(name = "Media", format = colFormat(separators = TRUE, digits = 2)),
      Mediana = colDef(name = "Mediana", format = colFormat(separators = TRUE, digits = 2)),
      DesvEst = colDef(name = "Desv. Est.", format = colFormat(separators = TRUE, digits = 2)),
      Min = colDef(name = "Mínimo", format = colFormat(separators = TRUE, digits = 2)),
      Max = colDef(name = "Máximo", format = colFormat(separators = TRUE, digits = 2))
    ),
    defaultPageSize = 5,
    searchable = TRUE,
    bordered = TRUE,
